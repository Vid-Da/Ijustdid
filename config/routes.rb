...
cancel_user_registration GET    /users/cancel(.:format)         devise/registrations#cancel
  ...
  edit_user_registration GET    /users/edit(.:format)           devise/registrations#edit
                    ...
                    root GET    /                               home#index
        api_achievements GET    /api/achievements(.:format)     achievements#index
                         POST   /api/achievements(.:format)     achievements#create
                         DELETE /api/achievements/:id(.:format) achievements#destroy
