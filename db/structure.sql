...
--
-- Name: fk_rails_651a652e8a; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY achievements
    ADD CONSTRAINT fk_rails_651a652e8a FOREIGN KEY (user_id) REFERENCES users(id);
...
INSERT INTO schema_migrations (version) VALUES ('20151207145245');

INSERT INTO schema_migrations (version) VALUES ('20151207150807');
